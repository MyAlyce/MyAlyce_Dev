...
export function Login({
    onLoginClick, companyName, onSignUpClick, isLoading,
    useRegularLogin, thirdPartyLogins, className, style,
}: LoginProps) {
    ...
    return <form
        className={classNames("bg-white rounded max-w-lg w-full p-10", className)}
        style={style}
